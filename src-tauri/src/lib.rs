...
use commands::{
    ...
    identify_mod_file, list_instance_content, list_instance_servers, list_instance_worlds,
    list_mod_configs, list_world_files,
    read_config_file, remove_content_file, set_content_enabled, write_config_file,
    read_world_file, write_world_file,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .manage(AppState {
            ...
            game_pids: std::sync::Mutex::new(std::collections::HashMap::new()),
            stop_requests: std::sync::Mutex::new(std::collections::HashSet::new()),
        })
